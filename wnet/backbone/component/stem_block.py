...
class StemBlock(nn.Module):
    ...
    def __init__(self, out_channel):
        ...
        self.conv312_1 = BasicConv(out_channel, out_channel, 3, 1, 2)
        self.conv312_2 = BasicConv(out_channel, out_channel, 3, 1, 2)
        self.conv101 = BasicConv(out_channel, out_channel, 1, 0, 1)
